...
ENV KC_DB='postgres'
ENV KC_DB_URL='jdbc:postgresql://db.buwvyjjfiyfcgcdvbfke.supabase.co:5432/pg-db'
ENV KC_DB_USERNAME='postgres'
ENV KC_DB_PASSWORD='Skyliner005!"£'
ENV KC_HOSTNAME='keycloak-ids'
ENV KEYCLOAK_ADMIN='admin'
ENV KEYCLOAK_ADMIN_PASSWORD='d55'
ENTRYPOINT ["/opt/keycloak/bin/kc.sh", "start", "--optimized", "--http-port=8080", "--db-driver=postgres"]
